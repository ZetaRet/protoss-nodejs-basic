declare namespace zetaret.node.modules {
	...
	export interface XProtoSSChe extends zetaret.node.ProtoSSChe {
		...
		onReadRequestBody(request: zetaret.node.Input, body: string, response: zetaret.node.Output): zetaret.node.modules.XProtoSSChe
		...
		endResponse(request: zetaret.node.Input, response: zetaret.node.Output): zetaret.node.modules.XProtoSSChe
	}
